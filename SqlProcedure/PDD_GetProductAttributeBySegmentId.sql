CREATE PROCEDURE PDD_GetProductAttributeBySegmentId
(
...
BEGIN
	...
	INNER JOIN  PDD_GetProductIdBySegmentId(@ProductSegmentManagerId,@VendorId) ps on pm.ProductId = ps.ProductId
